...
public class CloneFilter {
	...
	static {
		...
		options.addOption("t", true, "line threshold");
	...
	public static void main(String[] args) throws Exception {
		...
		String lineThreshString = cmd.getOptionValue("t");
		if (lineThreshString == null) {
			System.err.println("Invalid line threshold");
			System.exit(-1);
		}
		int lineThreshold = Integer.valueOf(lineThreshString);
